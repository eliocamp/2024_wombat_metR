...
So first we cut the EOF to keep only the first 2, reshape into wide, and then join with our dataset before doing a linear regression at each point and also for each season.
